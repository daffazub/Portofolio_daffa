    ...
    <>
      ...
      <main id="main-content">
        ...
        <section id="skills" className="section">
          <div className="container"><div className="section-heading centered reveal"><p className="eyebrow">02 / Keahlian</p><h2>Alat yang saya<br /><em>gunakan setiap hari.</em></h2></div><div className="skills-grid">{skillGroups.map((group) => <article className="skill-card reveal" key={group.title}><div className="card-topline"><span className="mono">{group.index}</span><i className={`fa-solid ${group.icon}`} aria-hidden="true" /></div><h3>{group.title}</h3><ul className="stack-list">{group.skills.map((skill) => <li key={skill}><span className="list-dot" />{skill}</li>)}</ul></article>)}</div></div>
        </section>
        ...
        <section id="education" className="section"><div className="container"><div className="section-heading reveal"><p className="eyebrow">04 / Edukasi</p><h2>Fondasi untuk<br /><em>terus bertumbuh.</em></h2></div><div className="education-list"><article className="education-item reveal"><span className="mono">01</span><div><h3>Teknik Informatika</h3><p>Politeknik Negeri Jember</p><small><strong className="mono">2024 - Sekarang</strong> <span>/</span> Rekayasa perangkat lunak, algoritma, basis data</small></div></article><article className="education-item reveal"><span className="mono">02</span><div><h3>Teknik Komputer dan Jaringan</h3><p>SMK Yadika 13</p><small><strong className="mono">2021 - 2024</strong> <span>/</span> Jaringan komputer, server, dan troubleshooting</small></div></article></div></div></section>
