  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        <section id="education" className="section"><div className="container"><div className="section-heading reveal"><p className="eyebrow">04 / Edukasi</p><h2>Fondasi untuk<br /><em>terus bertumbuh.</em></h2></div><div className="education-list"><article className="education-item reveal"><span className="mono">01</span><div><h3>Teknik Informatika</h3><p>Politeknik Negeri Jember</p><small><span className="mono">2024 - Sekarang</span> <span>/</span> Rekayasa perangkat lunak, algoritma, basis data</small></div></article><article className="education-item reveal"><span className="mono">02</span><div><h3>Teknik Komputer dan Jaringan</h3><p>SMK Yadika 13</p><small><span className="mono">2021 - 2024</span> <span>/</span> Jaringan komputer, server, dan troubleshooting</small></div></article></div></div></section>
